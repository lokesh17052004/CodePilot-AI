...
class BuildGraphException(AppBaseException):
    def __inti__(self,detail:str="Failed to build a graph"):
        super().__init__(
            error_code=ErrorCodeStatus.get(ErrorCode.BUILD_GRAPH_FAILED),
            message=detail,
            status_code=500
        )
